...
export const TableCellConditionOperatorTypes = {
  [OperatorTypes.Equal]: ['string', 'geoCountry', 'geoProvince', 'geoCity', 'geoDistrict', 'number', 'date'],
  [OperatorTypes.NotEqual]: ['string', 'geoCountry', 'geoProvince', 'geoCity', 'geoDistrict', 'number', 'date'],
  ...
  [OperatorTypes.Contain]: ['string', 'geoCountry', 'geoProvince', 'geoCity', 'geoDistrict'],
  [OperatorTypes.Between]: ['number', 'date'],
  [OperatorTypes.In]: ['string', 'geoCountry', 'geoProvince', 'geoCity', 'geoDistrict', 'number', 'date']
}
