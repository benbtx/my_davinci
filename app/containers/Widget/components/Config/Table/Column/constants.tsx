...
export const TableConditionStyleTypesSetting = {
  [TableConditionStyleTypes.BackgroundColor]: ['string', 'geoCountry', 'geoProvince', 'geoCity', 'geoDistrict', 'number', 'date'],
  [TableConditionStyleTypes.TextColor]: ['string', 'geoCountry', 'geoProvince', 'geoCity', 'geoDistrict', 'number', 'date'],
  [TableConditionStyleTypes.NumericBar]: ['number'],
  [TableConditionStyleTypes.Custom]: ['string', 'geoCountry', 'geoProvince', 'geoCity', 'geoDistrict', 'number', 'date']
}
