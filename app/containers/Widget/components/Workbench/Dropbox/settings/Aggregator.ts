...
const AggregatorDimension: ISettingItem = {
  ...
  constrants: [{
    settingType: SettingTypes.Indicator | SettingTypes.Tip,
    itemType: ItemTypes.Value,
    itemValueType: ItemValueTypes.Date | ItemValueTypes.GeoDistrict| ItemValueTypes.GeoCity | ItemValueTypes.GeoCountry | ItemValueTypes.GeoProvince | ItemValueTypes.String
  }],
  sub: false,
  items: [{
    count: getAggregatorLocale('count'),
